...
class Config:
    _DEFAULTS = {
        ...
        'RETRY_403_MAX': '0',
        'COOKIEFILE_ON_NO_FORMATS_ONLY': 'false',
        'YTDL_OPTIONS': '{}',
        'YTDL_OPTIONS_FILE': '',
        'ROBOTS_TXT': '',
        'HOST': '0.0.0.0',
    ...
    _BOOLEAN = ('DOWNLOAD_DIRS_INDEXABLE', 'CUSTOM_DIRS', 'CREATE_CUSTOM_DIRS', 'DELETE_FILE_ON_TRASHCAN', 'PLAYLIST_ITEMS_OLDEST_FIRST', 'SKIP_EXISTING_DOWNLOADS', 'COOKIEFILE_ON_NO_FORMATS_ONLY', 'HTTPS', 'ENABLE_ACCESSLOG')
